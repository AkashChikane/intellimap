...
| Windows `python` not found | Install Python 3.11–3.14 from python.org and tick “Add to PATH” |
| Windows pip “error while generating package metadata” | Python 3.14 needs current pins (`pydantic` 2.13+, `fastapi` 0.141+). `git pull`, delete leftover `backend\.venv`, retry `start.bat` |
